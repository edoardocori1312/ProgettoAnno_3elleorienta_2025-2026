<?php
    ...
    $_SESSION["emailUtente"] = "prova@gmail.com";
    $_SESSION["usernameUtente"] = "adminProva";
    $_SESSION["idUtente"] = 1;
    $_SESSION["ruoloUtente"] = "ADMIN";
    $_SESSION["cod_scuola"] = "ANIS023002";
...
<aside class="sidebar">
    ...
    <nav class="nav-group mt-2">
        ...
        <a href="pages/zona.php" class="nav-link" data-page="Zona">
            <i class="bi bi-geo-fill"></i>
            <span class="link-text">Zona</span>
        </a>

        <div class="nav-label mt-2">AVVENIMENTI</div>
        <a href="pages/eventi.php" class="nav-link" data-page="Eventi">
            <i class="bi bi-calendar-fill"></i>
            <span class="link-text">Eventi</span>
        </a>
        <a href="pages/progetti.php" class="nav-link" data-page="Progetti">
            <i class="bi bi-lightbulb-fill"></i>
            <span class="link-text">Progetti</span>
        </a>
        <a href="pages/link.php" class="nav-link" data-page="Link Utili">
            <i class="bi bi-link-45deg"></i>
            <span class="link-text">Link Utili</span>
        </a>

        <div class="nav-label mt-2">UTENTI</div>
        <a href="pages/utenti.php" class="nav-link" data-page="Gestione Utenti">
            <i class="bi bi-people-fill"></i>
            <span class="link-text">Gestione Utenti</span>
        </a>

        <div class="nav-label mt-2">ALTRO</div>
        <a href="pages/impostazioni.php" class="nav-link" data-page="Impostazioni">
...
<div class="main-wrapper">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" id="breadcrumb-current">Scuole</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <button class="btn btn-primary shadow-sm d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#modalEventi">
            <i class="bi bi-plus-circle"></i> Aggiungi scuola
        </button>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content shadow">
            <div class="modal-header bg-light">
                <h5 class="modal-title fw-bold" id="projectModalTitleEventi">Nuova scuola</h5>
