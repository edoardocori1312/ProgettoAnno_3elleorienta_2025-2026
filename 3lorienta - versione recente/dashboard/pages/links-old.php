<?php
    ...
    class LinkManager {
        ...
        public function aggiungiLink(string $titolo, string $url_link, string $descrizione, int $n_ordine): bool {
            $id_foto = null; 
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['azione'])) {
        ...
        elseif($_POST['azione'] === "aggiungi") 
        {
            ...
            $linkManager->aggiungiLink($titolo, $url_link, $descrizione, $n_ordine);
            echo "<script>window.location.href = 'index.php?page=links';</script>";
            exit();
        }
