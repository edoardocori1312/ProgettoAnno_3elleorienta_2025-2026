...
while ($r = $res->fetch_object()) { $ambiti[] = $r; }
...
$foto = [];
$res = $conn->query("SELECT ID_foto, path_foto FROM Foto");
while ($f = $res->fetch_object()) 
    { 
        $foto[$f->ID_foto] = $f->path_foto; 
    }
...
<div class="header">
    <h1>Orientati</h1>
    <p class="paragraph">Esplora le scuole del territorio e trova il percorso giusto per te</p>
</div>
...
<div class="container results-area">
    ...
    <div class="school-card" id="<?= $card_id ?>">
        ...
        <div class="card-body-content">
            <div class="image">
                <img src="<?php echo($foto[$s->id_foto]); ?>" alt="Immagine ambito">
                
            </div>
            <div class="col-info">
                <div class="section-label">Descrizione</div>
                <p class="desc-text"><?= SostituisciLink(nl2br(htmlspecialchars($s->descrizione))) ?></p>
                        ...
                        ?>
                            <li class="evento-item">
                                ...
                                <?php if ($ev->descrizione_breve): ?>
                                    <div class="evento-desc"><?= SostituisciLink(htmlspecialchars($ev->descrizione_breve)) ?></div>
                                <?php endif; ?>
