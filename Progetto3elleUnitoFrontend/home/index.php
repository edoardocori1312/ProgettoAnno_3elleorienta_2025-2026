...
$logo_svelati = "../img/logoSvelati.jpg"; // fallback locale
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <div class="hero-slide">
        <img src="../img/slide1.jpg" alt="Studenti a scuola">
    ...
    <div class="carousel-item">
      <div class="hero-slide">
        <img src="../img/slide2.jpg" alt="Orientamento scolastico">
        <div class="hero-caption">
    ...
    <div class="carousel-item">
      <div class="hero-slide">
        <img src="../img/slide3.jpg" alt="Reti territoriali">
        <div class="hero-caption">
  ...
  <div class="progetto-inner">
    ...
    <div class="progetto-text">
      ...
      <div class="progetto-buttons">
        ...
        <a href="../eventi/eventi.php"       class="btn-eventi">Eventi</a>
      </div>
    </div>
