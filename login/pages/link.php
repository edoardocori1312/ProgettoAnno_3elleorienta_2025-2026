...
<aside class="sidebar">
    ...
    <nav class="nav-group mt-2">
        ...
        <a href="index_scuole_backend" class="nav-link" data-page="Scuola">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page" id="breadcrumb-current">Link utili</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content shadow">
            <div class="modal-header bg-light">
                <h5 class="modal-title fw-bold" id="projectModalTitleEventi">Nuovo link</h5>
