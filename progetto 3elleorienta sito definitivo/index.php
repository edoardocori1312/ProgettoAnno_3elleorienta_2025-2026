...
<?php
include("navbar.html");
$logo_svelati  = "pictures/logo.jpg";
$titolo_progetto = "SVELATI";

$sql = "SELECT p.titolo, f.path_foto FROM Progetti p JOIN Foto f ON f.ID_foto = p.id_foto WHERE p.n_ordine = 1 AND p.data_eliminazione IS NULL AND f.data_eliminazione IS NULL LIMIT 1";

$result = $conn->query($sql);
if ($result && $row = $result->fetch_assoc()) {
    $logo_svelati    = $row["path_foto"];
    $titolo_progetto = strtoupper($row["titolo"]);
}
?>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active">
      <div class="hero-slide">
        <img src="pictures/home/slide1.jpg" alt="Studenti a scuola">
    ...
    <div class="carousel-item">
      <div class="hero-slide">
        <img src="pictures/home/slide2.jpg" alt="Orientamento scolastico">
        <div class="hero-caption">
    ...
    <div class="carousel-item">
      <div class="hero-slide">
        <img src="pictures/home/slide3.jpg" alt="Reti territoriali">
        <div class="hero-caption">
  ...
  <div class="progetto-inner">
    ...
    <div class="progetto-text">
      ...
      <div class="progetto-buttons">
        <a href="/Orientati/index.php" class="btn-orientati">Orientati</a>
        <a href="/Eventi/index.php" class="btn-eventi">Eventi</a>
      </div>
    </div>
